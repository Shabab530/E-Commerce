...
if(isset($_POST['admin_update_profile'])){
   ...
   $admin_update_profile = $conn->prepare("UPDATE `users` SET name = ?, email = ? WHERE id = ?");
   $admin_update_profile->execute([$name, $email, $admin_id]);
...
<section class="update-profile">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         <input type="submit" class="btn" value="update profile" name="admin_update_profile">
